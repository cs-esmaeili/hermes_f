        ...
        <div className='flex flex-col grow max-w-full gap-3'>
            <div className="flex flex-col bg-primary rounded-md gap-3 p-3">
                <div className="flex flex-row bg-secondary p-2">
                    <CustomInput value={"/temp/test/"} inputClassName={"ltr w-full"} containerClassName={"w-full"} />
                </div>
                <div className="flex flex-col md:flex-row gap-3">
                    <DivButton className={`bg-secondary md:!w-fit text-yellow-400 ${process.env.NEXT_PUBLIC_DIRECTION}`}>
