...
import TicketList from '@/components/dashboard/ticketAdmin/TicketList';
import TicketDetails from '@/components/dashboard/ticketAdmin/TicketDetails';
            ...
            <div className='w-full h-fit xl:w-1/4'>
                <NavigationMenu
                    ...
                    items={[
                        ...
                        { page: "tickDetails", icon: "addnote", label: "محتوا تیکت" },
                    ]}
                />
            </div>
