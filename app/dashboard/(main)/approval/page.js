            ...
            <div className='flex grow w-full overflow-x-scroll rounded-md '>
                {approvals &&
                    <Table
                        ...
                        rowsData={["_id", "draft.approval.approval_time", "draft.approval.title", "draft.approval.status"]}
                        rows={approvals}
                            ...
                            return (
                                <div className="flex h-full items-center justify-center gap-5 text-nowrap rounded-lg">
                                    <div className='w-fit  flex !flex-col gap-2 bg-secondary'  >
                                        <CustomInput placeholder="دلیل رد" defaultValue={rowData.draft.approval.comment} containerClassName="border-2 rounded-lg !border-red-500" ref={commentRef} />
