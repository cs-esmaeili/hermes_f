...
const CreateUser2 = ({ setParentLoading, scrollbarRef }) => {
    ...
    return (
        <div className='flex flex-col grow max-h-full overflow-hidden gap-3 bg-primary rounded-xl p-5'>
            ...
            <div className='flex flex-col-reverse md:flex-row grow gap-5'>
                ...
                <div className='flex items-center justify-center bg-secondary w-full md:w-2/6 p-20 rounded-md'>
