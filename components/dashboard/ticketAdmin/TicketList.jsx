...
import useAdminTicketList from '@/hooks/adminTicket/useAdminTicketList';
...
const TicketList = ({ setParentLoading, setSelectedTicket }) => {
    ...
    const { getAdminTicketsRequest } = useAdminTicketList((data) => {
    ...
    useEffect(() => {
        getAdminTicketsRequest({ page: activePage, perPage });
    }, [activePage]);
