    ...
    return (
        ...
        >
            ...
            <ul
                ...
                className={`absolute right-0 top-full transform transition duration-300 ease-out ${open
            ...
            <noscript>
                <ul
                    ...
                    className={`absolute right-0 top-full ${menuClassName ? menuClassName : "w-48 bg-secondary rounded-md shadow-md text-textcolor"
                        }`}
                >
                    {items.map((item, index) => (
                        <li key={index}>
...
function MenuItem({ item }) {
    ...
    return (
        ...
        >
            ...
            {hasSubMenu && openSub && (
                <ul
                    className={`absolute right-full top-0 mt-0 ml-0 ${item.subMenuClassName
